...
\begin{itemize}
	\item Programming Language: Python, C++, Java, Javascript
	\item Library: Tensorflow, Numpy, Pandas, Spark, Matplotlib, Node, ReactJS
	\item Database: SQL, MongoDB
	\item Software: Git, Linux, \LaTeX, Jenkins, Jupyter Notebooks
